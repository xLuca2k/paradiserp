...
Menu.prototype.updateColor = function(color)
{
  menuColor = color;
}
...
Menu.prototype.setSelected = function(i)
{
  ...
  var selectedChoice = document.getElementsByClassName('selected');
  if(selectedChoice[0]){
    selectedChoice[0].style.backgroundColor = "";
  }
  ...
  if(menuColor !== ""){
    var selectedChoice = document.getElementsByClassName('selected');
    if(selectedChoice[0]){
      selectedChoice[0].style.backgroundColor = menuColor;
    }
  }
